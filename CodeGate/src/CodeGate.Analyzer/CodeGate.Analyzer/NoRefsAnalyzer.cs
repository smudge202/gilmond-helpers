...
namespace CodeGate.Analyzer
{
	...
	public class NoRefsAnalyzer : DiagnosticAnalyzer
	{
		...
		private const string MessageFormat = "The ref keyword on parameter '{0}' is likely a lazy way of extending the result set of the method.";
		private const string Category = "Usage";
		private const string HelpUri = "http://blog.devbot.net/conventions-refs/";
